...
{
    public class UpperCharKeyboardPanel : MonoBehaviour
    {
        [SerializeField]
        ...
        internal void SetSystem(UpperCharKeyboardSystem system)
        {
        ...
        internal void SetKeyboradDirection(KeyboradDirectionCode keyboradDirection)
        {
